...
function IslamicLessonMt() {
    return (
        ...
        <ul className='space-y-6'>
                <li>
                    <a href={process.env.PUBLIC_URL + 'https://drive.google.com/file/d/1OZhVB0EjEsKjTxQq8N_qh_CSe9DhMsM8/view?usp=sharing'} className="pr-16 pl-16 pt-2 pb-2 rounded-full transition-transform duration-300 transform hover:-translate-y-2 hover:shadow-lg bg-red-300 ">
                    ملخصات شاملة
                    </a>
                </li>   
        </ul>
...
export default IslamicLessonMt