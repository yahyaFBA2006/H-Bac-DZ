...
function IlecLesson() {
  return (
    ...
    <li>
                <a href={process.env.PUBLIC_URL + 'https://drive.google.com/file/d/16e4L_J3A2FKVSz8mgjofx9fr8g3fcTG-/view?usp=sharing'} className="pr-16 pl-16 pt-2 pb-2 rounded-full transition-transform duration-300 transform hover:-translate-y-2 hover:shadow-lg bg-red-300 ">
ملخص جميع القوانين
            </a>
            </li>
