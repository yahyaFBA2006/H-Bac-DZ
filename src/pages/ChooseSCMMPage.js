...
<Link to="/SCSCTest " >
    ...
    <Link to="/SCSCBook" >
        ...
        <Link to="/SCSCLesson" >
        <div className="bg-red-500 rounded-lg shadow-2xl   pb-10   p-4 m-8 mt-2 w-56 transition-transform duration-300 transform hover:-translate-y-2 hover:shadow-lg ">
