...
<Link to="/IslamicTestMt" >
    ...
    <Link to="/IslamicBookPage" >
        ...
        <Link to="/IslamicLessonMt" >
        <div className="bg-red-500 rounded-lg  pb-10   shadow-2xl p-4 m-8 mt-2 w-56 transition-transform duration-300 transform hover:-translate-y-2 hover:shadow-lg ">
...
export default ChooseIslamicPage