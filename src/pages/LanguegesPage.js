...
import Italy from '../assets/italy_18275.png'
import Almand from '../assets/germany_18269.png'
import Spaim from '../assets/spain_18283.png'

function LanguegesPage() {
    return (
        <div>
          <div>
    ...
    <Link to="/AlmandBacExame ">
        <div className="bg-green-300 rounded-lg shadow-2xl p-4 m-12 w-56 transition-transform duration-300 transform hover:-translate-y-2 hover:shadow-lg ">
            <img src={Almand} alt="Card" className="w-20 mb-4 ml-12 rounded-lg" />
            <div className="text-gray-800">
            <h3 className="text-white text-center text-3xl font-extrabold mb-2">
اللغة الالمانية
            </h3>
            <p className="text-sm text-black text-center pt-3 ">
        ...
        <Link to="/Italian">
            <div className="bg-teal-400 rounded-lg shadow-2xl p-4 m-12 w-56 transition-transform duration-300 transform hover:-translate-y-2 hover:shadow-lg ">
            <img src={Italy} alt="Card" className="w-20 mb-4 ml-12 rounded-lg" />
            <div className="text-gray-800">
            <h3 className="text-white text-center text-3xl font-extrabold mb-2">
اللغة الايطالية
                 </h3> 
    ...
    <Link to="/SpanichBacExame">
        <div className="bg-violet-400 rounded-lg shadow-2xl p-4 m-12 w-56 transition-transform duration-300 transform hover:-translate-y-2 hover:shadow-lg ">
            <img src={Spaim} alt="Card" className="w-20 mb-4 ml-12 rounded-lg" />
            <div className="text-gray-800">
            <h3 className="text-white text-center text-3xl font-extrabold mb-2"> 
            اللغة الاسبانية
            </h3>
