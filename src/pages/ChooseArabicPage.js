...
<Link to="/ArabicTestMt" >
      <div className="bg-yellow-400 rounded-lg shadow-2xl p-4 m-8 mb-4 pb-10 w-56 transition-transform duration-300 transform hover:-translate-y-2 hover:shadow-lg ">
...
export default ChooseArabicPage