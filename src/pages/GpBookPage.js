              ...
              <div className='pb-4'>
                <h1 className='text-center font-extrabold  pt-8 opacity-0 animation-delay-4000 animate-pulse hover:opacity-100 border-t-2 border-black text-xl'>
                  توكل على اللَّه
                          ...
                          <li>
                    <a href={process.env.PUBLIC_URL + 'https://eddirasa.com/wp-content/uploads/2022/11/procedes-3as-livre_scolaire.pdf'} className="pr-2 pl-2 pt-2 pb-2 rounded-full transition-transform duration-300 transform hover:-translate-y-2 hover:shadow-lg bg-red-300 ">
