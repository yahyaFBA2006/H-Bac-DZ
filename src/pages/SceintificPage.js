...
function SceintificPage() {
    return (
        ...
        مرحبا بكم يا طلاب شعبة  علوم تجريبية
          </h1>
        </div>
        <div>
